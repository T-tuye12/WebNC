                        ...
                        ?>
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="category_product_desc"style="resize:none" row="10" class="form-control" name ="category_product_desc" id="exampleInputPassword1" placeholder="Mô tả danh mục"></textarea>
                                </div>
                                <div class="form-group">
